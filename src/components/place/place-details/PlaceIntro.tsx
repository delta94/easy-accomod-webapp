    ...
    <NavLabel className='place-details-overviews' name='overview'>
      ...
      <Box mt={4}>
        <Stack spacing='5px' direction='row'>
          ...
          {roomData?.num_of_bedroom} phòng ngủ ·
          <Text>{roomData?.num_of_kitchen} phòng bếp ·</Text>
          {roomData?.num_of_bed} giường ·
          <Text>{roomData?.num_of_bathroom} phòng tắm</Text>
            ...
            <Box
              ...
              <Box p={3} fontSize='sm'>
                <Box className='coupon-des'>
                  Khuyến mãi{' '}
                  <strong style={{ color: '#FF0037' }}>
                    {singleCoupon?.discount}%
                  </strong>{' '}
                  -
                  <strong style={{ color: '#FF0037' }}>
                    {' '}
                    {singleCoupon?.code_name}
                  </strong>
                  <br />
